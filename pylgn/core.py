...
class Ganglion(Neuron):
    ...
    def _check_if_connection_is_allowed(self, neuron):
        ...
        if not isinstance(neuron, (Ganglion)):
            raise TypeError("Unsupported connection to Ganglion cell: ", type(neuron))
    ...
    def evaluate_irf_ft(self, w, kx, ky):
        ...
        impulse-response function
        """
        retinal_input = self.kernel(w, kx, ky)
